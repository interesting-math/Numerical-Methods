...
*/
    ...
    /*
    static double First_Derivative_Function_For_Coordinate_Descent_Method(double[] x) {
    ...
    */
    ...
    /*
    static boolean Break_Condition_3_For_Coordinate_Descent_Method(int n, double[] x_cur, double[] x_prev, double E) {
        if (Math.abs(First_Derivative_Function_For_Coordinate_Descent_Method(x_prev)) < E) {
            return true;
        }
        return false;
    }
    */
    ...
    static void Coordinate_Descent_Method() {
        ...
        int n = 2;
        System.out.println("f(x) = Math.pow(x[1] - x[0]*x[0], 2.0) + Math.pow(1.0 - x[0], 2.0)");
     /*
...
//                System.out.println();
    ...
    static double Derivative_For_Kutta_Merson_Method(double x, double y) {
        return Math.pow(x, 2.0);
    }
    
    static void The_Kutta_Merson_Method() {
        Scanner sc = new Scanner(System.in);
        ...
        double k1 = Derivative_For_Kutta_Merson_Method(x, y);
        
        for (int iteration = 1; true; iteration++) {    
            double k2 = Derivative_For_Kutta_Merson_Method(x + h/3, y + h/3 * k1);
            double k3 = Derivative_For_Kutta_Merson_Method(x+h/3, y + h/6 * k1 + h/6 * k2);
            double k4 = Derivative_For_Kutta_Merson_Method(x + h/2, y + h/8 * k1 + 3*h/8 * k2);
            double k5 = Derivative_For_Kutta_Merson_Method(x + h, y + h/2 * k1 - 3*h/2 * k3 + 2*h * k4);
            
            double Y_next = y + h/2 * (k1 - 3*k3 * 4*k4);
            double y_next = y + h/6 * (k1 + 4*k4 * k5);
            
            double R = 0.2 * Math.abs(Y_next - y_next);
            
            System.out.println("x: " + x + "; y: " + y + "; ~y: " + Y_next);
    ...
    static void Steepest_Descent_Method() {
